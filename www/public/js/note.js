    ...
    render() {
        return `   <div class="wall__item-content">
          ...
          <div class="wall__item-content__badge">
            <svg class="wall__item-content__badge_book" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                 viewBox="0 0 24 24">
          ...
          <div class="wall__item-content_main">
            ...
            <div class="wall__item-content-user wall__item-content_add">
              ...
              <div class="wall__item-content-user-main">
                ...
                <span class="wall__item-content-user-main_tittle wall__item-content_add_tittle">Note by Guy Mariano</span>
                <span class="wall__item-content-user-main_description wall__item-content_add_description">This Metric is a key indicator of our ability to retain users. Active for us means logged in and using the product for at least 10 minutes. The 10 minute marker allows us focus on dedicated users that are invested in the product.
                </span>
            ...
            <div class="wall__item-content_main wall__item-content_add">

              <div class="wall__item-content-user">
                <img src="images/Lady.png">
                <div class="wall__item-content-user-main">


                  <span class="wall__item-content-user-main_tittle">Louis Bedard</span>
                  <span class="wall__item-content-user-main_description">Look at our inventory level right now; seems really low.</span>
                  <div class="wall__item-content-user-main-actions">
                    <div class="wall__item-content-user-main-actions-item">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0z" fill="none"/>
